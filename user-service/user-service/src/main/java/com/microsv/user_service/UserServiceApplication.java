	...
	CommandLineRunner commandLineRunner(
		...
		return args -> {
			...
			if (userRepository.findByUserName("admin").isEmpty()) {
				...
				admin.setPassword(passwordEncoder.encode(defaultAdminPassword)); // Mã hóa mật khẩu
			...
			if (userRepository.findByUserName("user").isEmpty()) {
				...
				user.setPassword(passwordEncoder.encode(defaultUserPassword)); // Mã hóa mật khẩu
